...
namespace Task_Management_System.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(7, ErrorMessage = "Kod weryfikacyjny musi sk³adaæ siê z 6 cyfr.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("U¿ytkownik o ID '{UserId}' w³¹czy³ uwierzytelnianie 2FA za pomoc¹ aplikacji uwierzytelniaj¹cej.", userId);
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Task Management System"),
